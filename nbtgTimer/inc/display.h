/**
 * @file  display.h
 * @brief 128x64 oled display routines (SSD1309)
 */
...
#define SSD1309_MEMORY_MODE \
    0x20 // 0x02 [reset] 0x00 - Horizontal addressing; 0x01 - Vertical addressing 0x02 - Page Addressing; 0x03 - Invalid
#define SSD1309_COLUMN_ADDR \
    0x21 // used with horizontal or vertical addressing: { 0x21 0x00 0x7F } selects columns 0 to 127
...
#define SSD1309_SEG_REMAP_NORMAL \
    0xA0 // Used in conjunction with COM_SCAN_INC to rotate display such that Top of display is same side as the
         // connection strip.
#define SSD1309_SEG_REMAP_FLIP \
    0xA1 // Used in conjunction with COM_SCAN_DEC to rotate display such that Top of display is opposite side of the
         // connection strip.
